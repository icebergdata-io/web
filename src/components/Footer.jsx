        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/about" className="text-light-600 hover:text-white transition-colors">About</Link></li>
              <li><Link to="/services" className="text-light-600 hover:text-white transition-colors">Services</Link></li>
              <li><Link to="/case-studies" className="text-light-600 hover:text-white transition-colors">Case Studies</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-dark-700">
          <div className="flex flex-wrap justify-between items-center">
            ...
            <div className="flex flex-wrap gap-4 text-sm">
              <Link to="/terms" className="text-light-600 hover:text-white transition-colors">Terms & Conditions</Link>
              <Link to="/privacy" className="text-light-600 hover:text-white transition-colors">Privacy Policy</Link>
              <Link to="/cookies" className="text-light-600 hover:text-white transition-colors">Cookie Policy</Link>
              <Link to="/refund" className="text-light-600 hover:text-white transition-colors">Refund Policy</Link>
            </div>
          </div>
        </div>
      </div>
