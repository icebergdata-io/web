    ...
    <>
      <footer className="bg-dark-900 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-8 md:py-12 relative z-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            ...
            <div className="text-center sm:text-left">
              <div className="flex items-center gap-4 mb-4 justify-center sm:justify-start">
                <Logo size="small" />
                <h3 className="text-lg md:text-xl font-display font-bold">Iceberg Data</h3>
              </div>
              <p className="text-light-600 mb-6 text-sm md:text-base">
            ...
            {/* Solutions */}
            <div className="text-center sm:text-left">
              <h3 className="text-lg md:text-xl font-display font-bold mb-4">Sections</h3>
              <ul className="space-y-3">
                <li>
                  <button 
                    onClick={() => handleNavClick('solutions')} 
                    className="text-light-600 hover:text-white transition-colors text-sm md:text-base"
                  >
                    Solutions
                  </button>
                </li>
                ...
                <li>
                  <Link to="/press" className="text-light-600 hover:text-white transition-colors text-sm md:text-base">
                    Press
                  </Link>
                </li>
                <li>
            ...
            {/* Contact */}
            <div className="text-center sm:text-left">
              <h3 className="text-lg md:text-xl font-display font-bold mb-4">Contact</h3>
              <ul className="space-y-3">
                <li className="flex items-center text-light-600 justify-center sm:justify-start">
                ...
                <li className="flex items-center text-light-600 justify-center sm:justify-start">
                  ...
                  <span className="text-sm md:text-base">447 Broadway, 2nd Floor – 1978, NY, New York, US, 10013</span>
                </li>
              </ul>
            </div>
            ...
            {/* Legal */}
            <div className="text-center sm:text-left">
              <h3 className="text-lg md:text-xl font-display font-bold mb-4">Legal</h3>
              <ul className="space-y-3">
                <li>
                  <button 
          ...
          {/* Copyright */}
          <div className="mt-8 md:mt-12 pt-6 md:pt-8 border-t border-dark-700">
            <div className="text-center sm:text-left">
