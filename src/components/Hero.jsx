    ...
    <>
      ...
      <main>
        ...
        >
          ...
          {/* Animated Gradients */}
          <div 
            className="absolute -right-64 -top-64 w-[800px] h-[800px] bg-gradient-to-br from-accent-purple/20 to-primary-300/20 rounded-full blur-3xl animate-pulse-slow"
            aria-hidden="true"
          ></div>
          <div 
            className="absolute -left-64 -bottom-64 w-[800px] h-[800px] bg-gradient-to-tr from-accent-cyan/20 to-primary-300/20 rounded-full blur-3xl animate-pulse-slow delay-1000"
            aria-hidden="true"
          ></div>
          ...
          <div className="max-w-7xl mx-auto px-4 py-32 relative">
            <div className="text-center">
              ...
              <h1 
                id="hero-title"
                className="text-5xl md:text-7xl font-display font-bold text-dark-900 mb-8 leading-tight opacity-0 animate-fade-in-up"
              >
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                >
                  <div 
                    className="absolute inset-0 bg-gradient-to-r from-primary-600 via-accent-purple to-primary-600 transition-all group-hover:scale-110 duration-300"
                    aria-hidden="true"
                  ></div>
            ...
            <div className="mt-12 flex justify-center">
              <div 
                className="flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-xl border border-white/20 shadow-lg" 
                role="status"
              >
                <svg 
